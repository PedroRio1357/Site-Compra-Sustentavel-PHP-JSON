...
<div class="menu">
 ...
 <ul>
  ...
  <li>  <a href = "novidades.php"> <a href = "#"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Produtos </a>
   ...
   <li class="#"> <a href = "sobre.php"><i class="fa fa-leaf" aria-hidden="true"></i>Sobre</a> </li>
   <li class="active"> <a href = "#"> <i class="fa fa-phone" aria-hidden="true"></i>Contato</a> </li>
 </ul>
</div>
...
<br><br><br>
 ...
 <div class="inicio">
    ...
    <h1>Contato:</h1>
<br>
<p>Como entrar em contato consoco?</p>
<br><br>



<h3>Se caso quiser falar conosco, você pode entrar em contato atráves <br> desses perfis do Twitter e do Instagram:<p>    <br>
    <i class="fa fa-twitter" aria-hidden="true"></i>&nbsp @pedrorio64</i>
    <br><br>
    <i class="fa fa-twitter" aria-hidden="true"></i>&nbsp @GustavoNeumann_</i>
    <br><br>
    <i class="fa fa-instagram" aria-hidden="true"></i>&nbsp @pedro_rio</i>
    <br><br>
    <i class="fa fa-instagram" aria-hidden="true"></i>&nbsp @guhh_777</i>
    </div><br><br><br>
