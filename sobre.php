...
<div class="menu">
 ...
 <ul>
  ...
  <li>  <a href = "novidades.php"> <a href = "#"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Produtos </a>
   ...
   <li class="active"> <a href = "#"><i class="fa fa-leaf" aria-hidden="true"></i>Sobre</a> </li>
...
<br><br><br>
 ...
 <div class="inicio">
    ...
    <h3>Esse site está sendo feito por dois alunos do IFSul Campus Charqueadas, <br>
         Pedro Rio de Souza e Gustavo Neumann para um projeto final da matéria <br> 
         de Programação Web (PW).<p>     
