 ...
 <ul>
  ...
  <li>  <a href = "novidades.php"> <a href = "#"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Produtos </a>
   ...
   <li class="active"> <a href = "#"> <a href = "#"><i class="fa fa-user"> </i>Perfil </a>
    ...
    <li><a href="#"><i class="fa fa-users" aria-hidden="true"></i>Vendedores</a></li>
    ...
    <div class="row">
        <table class="table caption-top" id="myTable">
            ...
            <tr>
                ...
                <th scope="col"><h2>Senha:</h2></th>
                <th scope="col"><h2>Endereço:</h2></th>
                <th scope="col"><h2>Telefone:</h2></th>
                <th scope="col"><h2>Ação:</h2></th>
            </tr>
            </thead>
            <tbody>
               <tr>
...
<script type="text/javascript" async>
    ...
    const listaUsuarios = async (nome) => {
        ...
        respTabela.forEach(function (e) {
            ...
            cell2.innerHTML = `<br> <h2>${e.email}&nbsp  &nbsp </h2>`;
            cell3.innerHTML = `<br> <h2>${e.passw}&nbsp &nbsp &nbsp </h2>`;
            cell4.innerHTML = `<br> <h2>${e.address}&nbsp &nbsp</h2>`;
            cell5.innerHTML = `<br><h2>${e.phone} &nbsp &nbsp  </h2>`;
            cell6.innerHTML = ` <br> <h2><a href='#'><img src="assets/file.svg"></a>
