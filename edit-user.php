...
if($post){
    ...
    $arrayUsers = array_values($arrayUsers);
...
<div class="row">
        ...
        <form method="post" id="formUsers">
            <div class="mb-3"><br><br>
                <label for="name" class="form-label"><h2>Edite seus dados:<br><br>Nome:</h2></label><br>
            ...
            <div class="mb-3"><br>
                <label for="address" class="form-label"><h2>Endereço:</h2></label><br>
                <input type="text" name="address" class="form-control" id="address" value="Charqueadas">
            </div><br>
            <div class="mb-3"><br>
                <label for="phone" class="form-label"><h2>Telefone:</h2></label><br>
