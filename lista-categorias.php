...
<script type="text/javascript" async>
 // esse script recebe por GET a especialida
    ...
    console.log(cat);
    const listaCategorias = async (cat) => {
        const tabela = await fetch("categorias/list.php?cat=" + cat);
...
<br><br>
<h2> Acessa as outras listas por categoria: <a href = "lista-categorias.php?cat=garrafas">garrafa</a>; 
